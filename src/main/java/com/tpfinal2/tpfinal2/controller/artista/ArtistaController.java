...
public class ArtistaController {
    ...
    public ResponseEntity<List<ArtistaDto>> getArtistaWithName(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(artistaServices.allArtistas(nombre));
    }
    ...
    public ResponseEntity<ArtistaDto> getArtistaById(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(artistaServices.getArtistaById(id));
    }
